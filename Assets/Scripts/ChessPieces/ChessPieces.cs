...
public class ChessPieces : MonoBehaviour
{
    ...
    private Vector3 desiredScale =new Vector3(0.8f, 0.8f, 0.8f);
    ...
    public virtual void SetDesiredPosition(Vector3 position,bool force = false)
    {
    ...
    public virtual void SetDesiredScale(Vector3 scale, bool force = false)
    {
        desiredScale = scale;
        if (force)
        {
